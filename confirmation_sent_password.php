    ...
    <div class="container" style="margin-top :116px;">
         ...
         <div class="grid fluid">
                <div class="row" style="position:relative;">
                    ...
                    <div class="span12">
                        <p class="generic" style="color: #3E4252;font-weight: 600;font-family: Segoe UI_,Open Sans,Verdana,Arial,Helvetica,sans-serif;font-weight: 400; font-size: 24px;line-height: 1.55em;"   ><b>Password Reset /</b> Your confirmation code has been sent <i class="icon-mail on-right on-left"
        style="color: black;"></i></p>
                        ...
                        <p style="color: #606B7C; font-family: Sergoe UI Light_, Open Sans Light, Verdana, Arial, Helvetica, sans-serif;font-weight: 400; font-size: 18px;line-height: 1.55em;">
                             An Password Reset Confirmation email has been automatically sent to your primary address. Normally, this email will arrive in your inbox within a few minutes of reaching this screen.<br><br>

                             Having trouble ? <a href='contact.php'>Contact us </a> so we can assist you in the registration process. </p>
