   ...
   <div class="example" style="border: 0px; witdh: 100%; ">
        ...
        <div class="grid fluid">
                <div class="row" style="position:relative;">
                    ...
                    <div class="span6">
                        <p class="generic" style="color: #3E4252;font-weight: 600;font-family: Segoe UI_,Open Sans,Verdana,Arial,Helvetica,sans-serif;font-weight: 400; font-size: 24px;line-height: 1.55em;"><b>Help /</b> Account Access <i class="icon-key" style="background: black;color: white;padding: 7px;border-radius: 50%"></i></p>
                    ...
                    <div class="span6">
                        <p class="generic" style="color: #3E4252;font-weight: 600;font-family: Segoe UI_,Open Sans,Verdana,Arial,Helvetica,sans-serif;font-weight: 400; font-size: 24px;line-height: 1.55em;"><b>Help /</b> Searching Ressources <i class="icon-database" style="background: black;color: white;padding: 7px;border-radius: 50%"></i></p>
