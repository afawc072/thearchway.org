...
echo"<div class='example'><nav class='horizontal-menu'><ul><li><a href='oforceportal.php'>home</a></li><li><a href='profile.html'>profile</a></li><li><a href='upload/upload.php'>upload</a></li><li><a href='about.php'>help</a></li><div class='element place-right'><button class='large'>Sign out</button></div></ul></nav></div>";
}
else{
