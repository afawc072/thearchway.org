...
echo"<div class='example'><nav class='horizontal-menu'><ul><li><a href='index.php'>home</a></li><li><a href='upload.php'>upload</a></li><li><a href='about.php'>help</a></li><div class='element place-right'><li>Welcome, $_SESSION[username] </li><a href='logout.php'><button class='large'>Sign out</button></a></div></ul></nav></div>";
}
else{
